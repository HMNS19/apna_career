...
**Minimum Threshold Check (new):**
After Phase 1, if a user scores below the minimum baseline across **all 4 domains**, the system does not force a career match. Instead it:
...
1. **Problem Understanding** — What is the core problem being solved?
2. **Approach** — What solution or design approach would you take?
3. **Trade-offs** — What are the limitations or trade-offs of your approach?
4. **Decision** — What would you recommend and why?
...
| Supporting concept coverage | 20% |
| Logical structure / connectors | 20% |
| Completeness (L6 only) | 10% |
